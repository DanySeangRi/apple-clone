...
const Main = () => {
  return (
    <div className=''>
      ...
      <BigCard image={imageHome[0].image}   title={heroItem[0].title} description={heroItem[0].description}/>
       <BigCard image={imageHome[1].image}  title={heroItem[1].title} description={heroItem[1].description}/>
       <BigCard image={imageHome[2].image} title={heroItem[2].title} description={heroItem[2].description}  />
    </div>
